...
export class MainPageComponent implements OnInit {
  ...
  // ✅ Start Parser
  startParser(): void {
    this.http.get('https://lviv-pject.vercel.app//start_scraping/', {}).subscribe(() => {
  ...
  // ✅ Stop Parser
  stopParser(): void {
    this.http.get('https://lviv-pject.vercel.app//stop_scraping/', {}).subscribe(() => {
  ...
  startAutoPosting(): void {
    this.http.get('https://lviv-pject.vercel.app//start_autoposting/', {}).subscribe(() => {
  ...
  stopAutoPosting(): void {
    this.http.get('https://lviv-pject.vercel.app//stop_autoposting/', {}).subscribe(() => {
...
removeWatermarkAI(imageId: number, apartmentId: number): void {
  ...
  reorderImages(event: CdkDragDrop<ApartmentFile[]>, apartmentId: number): void {
    ...
    this.http.put(
      `https://lviv-pject.vercel.app//apartments/${apartmentId}/reorder_images`,
      orderUpdates
    ).subscribe(
      () => {
...
autoAssign() {
  ...
  fetchTrapWords(): void {
    this.http.get<string[]>('https://lviv-pject.vercel.app//admin/get_traps').subscribe(
  ...
  // Fetch Stop Words
  fetchStopWords(): void {
    this.http.get<string[]>('https://lviv-pject.vercel.app//admin/get_stop_words').subscribe(
  ...
  fetchVerificationApartments(): void {
    this.http.get<any[]>('https://lviv-pject.vercel.app//admin/verification_ads').subscribe(
  ...
  addTrapWord(): void {
    this.http.post('https://lviv-pject.vercel.app//admin/add_trap/', { word: this.newTrapWord }).subscribe(() => {
      this.fetchTrapWords();
      this.newTrapWord = '';
    });
  }
  ...
  removeTrapWord(word: string): void {
    this.http.delete(`https://lviv-pject.vercel.app//admin/remove_trap/${word}`).subscribe(() => {
      this.fetchTrapWords();
    });
  }
  ...
  // Add Stop Word
  addStopWord(): void {
    this.http.post('https://lviv-pject.vercel.app//admin/add_stop_word/', { word: this.newStopWord }).subscribe(() => {
      this.fetchStopWords();
      this.newStopWord = '';
    });
  }
  ...
  removeStopWord(word: string): void {
    this.http.delete(`https://lviv-pject.vercel.app//admin/remove_stop_word/${word}`).subscribe(() => {
      this.fetchStopWords();
    });
  }
  ...
  approveApartment(apartmentId: number): void {
    this.http.put(`https://lviv-pject.vercel.app//admin/verify_ad/${apartmentId}`, { decision: "relevant" }).subscribe(() => {
      this.fetchVerificationApartments();
    });
  }
  ...
  rejectApartment(apartmentId: number): void {
    this.http.put(`https://lviv-pject.vercel.app//admin/verify_ad/${apartmentId}`, { decision: "spam" }).subscribe(() => {
      this.fetchVerificationApartments();
    });
  }
  ...
  // Run Parser
  runParser(): void {
    this.http.post('https://lviv-pject.vercel.app//admin/run_parser/', {}).subscribe(() => {
  ...
  // Run Auto Posting
  runAutoPosting(): void {
    this.http.post('https://lviv-pject.vercel.app//admin/start_auto_posting/', {}).subscribe(() => {
